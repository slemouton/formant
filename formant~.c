...
void formant_perform64(t_formant *x, t_object *dsp64, double **ins, long numins, double **outs, long numouts, long sampleframes, long flags, void *userparam)
{
...
void formant_dsp64(t_formant *x, t_object *dsp64, short *count, double samplerate, long maxvectorsize, long flags)
{
    object_method(dsp64, gensym("dsp_add64"), x, formant_perform64, 0, NULL);
...
int C74_EXPORT main(void)
    {
        ...
        //newschool
        class_addmethod(c, (method)formant_dsp64, "dsp64", A_CANT, 0);     // respond to the dsp message
